 ...
 return (
    <div style={styles.cardWrapper}>
      ...
      <div style={styles.header}>
        <h2 style={styles.title}>Get E-Way Bills of Other Party</h2>
        <p style={styles.subtitle}>
          Enter details below to retrieve e-way bills generated by counter-parties.
        </p>
      </div>
          ...
          <table style={styles.table}>
            <thead>
              <tr style={styles.tableHeaderRow}>
                ...
                <th style={styles.th}>Gen GSTIN</th>
