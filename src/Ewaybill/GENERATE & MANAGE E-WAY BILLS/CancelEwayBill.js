    ...
    <div style={styles.outerContainer}>
      <div style={styles.card}>
        <div style={styles.header}>
          <span style={styles.badge}>Action</span>
          <h2 style={styles.title}>1. Cancel E-Way Bill</h2>
          <p style={styles.subtitle}>Submit a cancellation request with reason codes</p>
        </div>
